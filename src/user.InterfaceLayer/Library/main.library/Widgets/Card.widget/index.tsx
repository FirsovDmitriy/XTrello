...
const Card: FC = () => {
  ...
  return (
    <div className="group flex w-full border-b border-dark-border cursor-pointer">
        ...
        <NavLink to={'#'} className='flex-auto text-[0.875rem]'>
          ...
          <div className="flex justify-between">
            <span className="flex gap-4">
              <p>#1</p>
              <p className='text-secondary-textColor'>Иванов И.И. создал(а) 1 час назад</p>
            </span>

            <p className='text-secondary-textColor'>Баранов В.В. изменил(а) 1 минуту назад</p>
          </div>
        </NavLink>
